...
:::{region} nodes-pipeline-node-sequence/kernel
...
:::{region} the-aggregator-pattern/division-of-labor
...
:::{region} inputs-outputs/carrying-a-value-across-runs
Channels are
...
- **No mid-invocation partial values.**
  ...
  :::{region} orchestration-scope/no-partial-values
...
:::{region} in-process-compose-api/registry
...
:::{region} pipeline-result-runresult/shape
| Field | Type | Carries |
|---|---|---|
...
:::{region} composition-validation/error-reporting
...
- **Handler-declaration content** (for `kind = "handler"` entries;
  ...
  configurations.
- :::{transclude} what-the-pipeline-hash-absorbs/external-binding-content
  :::
...
:::{transclude} event-log-specification/per-kind-capture
:::
  ...
  - rule_id: R-pipeline-001
    ...
    statement: |
      ...
      **Read/write shape matching.** The check runs in two stages over
      ...
      :::{transclude} R-pipeline-001/readwrite-shape-matching
      :::
      ...
      **Binding supply matching.**
      :::{transclude} R-pipeline-001/binding-supply-matching
      :::
      ...
      **Identity/transport placement.**
      :::{transclude} R-pipeline-001/identity-placement
      :::
      :::{transclude} R-pipeline-001/transport-placement
      :::

      **Transport coverage.**
      :::{transclude} R-pipeline-001/transport-coverage
      :::

      **`inputs` / `outputs` field resolution.**
      :::{transclude} R-pipeline-001/inputs-outputs-resolution
      :::

      **API-invocation `inputs` enforcement.**
      :::{transclude} R-pipeline-001/api-inputs-enforcement
      :::
      :::{transclude} R-pipeline-001/input-closure
      :::
      ...
      **Streamable terminal-node placement.**
      :::{transclude} R-pipeline-001/streamable-terminal-node
      :::
...
:::{transclude} rule-fragments-convention/kernel
:::

:::{region} R-pipeline-001/readwrite-shape-matching
...
:::{region} R-pipeline-001/input-closure
...
:::{region} R-pipeline-001/binding-supply-matching
...
:::{region} R-pipeline-001/identity-placement
...
:::{region} R-pipeline-001/transport-placement
...
:::{region} R-pipeline-001/inputs-outputs-resolution
...
:::{region} R-pipeline-001/api-inputs-enforcement
...
:::{region} R-pipeline-001/transport-coverage
...
:::{region} R-pipeline-001/hook-transport-coverage
...
:::{region} R-pipeline-001/streamable-terminal-node
...
:::{region} R-pipeline-002/merge-kernel
