...
:::{region} channel-record-correspondence/bijection
...
:::{transclude} resolution-priority/dot-presence-selector
:::
...
:::{transclude} integrity-enforcement-opt-in/property-vs-enforcement
:::
...
:::{transclude} pipelinefailure-payload/failure-category
:::
...
:::{region} replayability/kernel-property
...
:::{region} trainable-channel/emission-locus
...
:::{transclude} field-validators/kernel
:::
