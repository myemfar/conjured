...
:::{region} handler-toml-grammar/composition-kind-roster
...
:::{transclude} the-mirror-pipeline-principle/kernel
:::
...
:::{region} bundle-composition-kind/grammar
...
channels.
:::{region} R-handler-001/output-validation
...
:::{region} binding-value-supply-grammar/normalization
...
:::{region} binding-value-supply-grammar/explicit-null
...
:::{region} transport_schema/stdlib-non-empty
...
- `description` — a one-sentence statement of what a field IS, and **model-facing contract
  ...
  :::{region} toml-field-type-discipline/description-admission
...
:::{region} field-validators/kernel
...
:::{region} compose-time-work-homes/homes
...
:::{region} channel-type-discipline/reference-convention
...
:::{region} the-service-type-adapter/body-side-call-convention
...
:::{region} the-service-type-adapter/construction-lifecycle
...
:::{region} trainable-wire/rejected-class
...
:::{region} derived-rules-convention/kernel
...
rules:
  - rule_id: R-handler-001
    ...
    statement: |
      ...
      :::{transclude} R-handler-001/bare-function-dispatch
      :::
  ...
  - rule_id: R-handler-pure-module
    ...
    statement: |
      ...
      :::{transclude} R-handler-pure-module/enforcement
      :::
...
:::{region} rule-fragments-convention/kernel
...
:::{region} R-handler-001/signature-union
...
:::{region} R-handler-001/bare-function-dispatch
...
:::{region} R-handler-002/fallback-pattern-catalog
...
:::{region} R-handler-002/evidentiary-backing-classification
...
:::{region} R-handler-003/discriminator
...
:::{region} R-handler-004/mechanical-half
...
:::{region} R-handler-004/forbidden-patterns
...
:::{region} R-handler-005/literal-equal-kernel
...
:::{region} R-handler-006/reject-unknown-blocks
...
:::{region} R-handler-007/import-namespace-lists
...
:::{region} R-handler-008/service-binding-cardinality
...
:::{region} R-handler-008/trainable-binding-cardinality
...
:::{region} R-handler-010/no-author-body
...
:::{region} R-handler-011/config-vs-reads-split
...
:::{region} R-handler-bare-function/predicate-admit-reject
...
:::{region} R-handler-pure-module/forbidden-patterns
...
:::{region} R-handler-pure-module/adapter-scope
...
:::{region} R-handler-pure-module/enforcement
